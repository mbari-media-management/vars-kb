...
public class H2TestDAOFactory {
    ...
    public static EntityManagerFactory newEntityManagerFactory() {
        String driver = config.getString("org.mbari.vars.knowledgebase.database.h2.driver");
        String url = config.getString("org.mbari.vars.knowledgebase.database.h2.url");
        String user = config.getString("org.mbari.vars.knowledgebase.database.h2.user");
        String password = config.getString("org.mbari.vars.knowledgebase.database.h2.password");
